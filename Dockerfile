...
RUN DATABASE_URL="postgresql://postgres:YYzvHBOctTMCUfPtntsucYcitLFblzCS@gondola.proxy.rlwy.net:49156/railway" REDIS_URL="redis://localhost:6379" turbo build --filter=@trakyahaber/web
